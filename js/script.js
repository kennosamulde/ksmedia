$(document).ready(function () {
  ...
  $(".js--scroll-to-contact, .js--scroll-to-contact-2").click(function () {
  ...
  $(".js--capabilities").click(function () {
    t1.reverse().timeScale(2)
